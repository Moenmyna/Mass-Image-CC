...
# "cjxl", as this is a LOSSY conversion

# Find all the .jpg/jpeg files in the current working directory, invoke the magick command on each file, 
# convert those files to .jxl with the quality setting at "95", do this until all files have been converted.
