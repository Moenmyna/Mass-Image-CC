...
# Find all the .jpg files in the current working directory, invoke the magick command on each file, 
# convert those files to .avif with the quality setting at "96", do this until all files have been converted.
